...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // grammary
        if (0 === strpos($pathinfo, '/grammary') && preg_match('#^/grammary(?:/(?P<grammary_package>[^/]++))?$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'grammary')), array (  'grammary_package' => NULL,  '_controller' => 'Dwr\\FrontendBundle\\Controller\\GrammaryController::indexAction',));
        }
