 ...
 */
class Grammary extends \Dwr\FrontendBundle\Entity\Grammary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'title', 'content', 'comment', 'part', 'subpart');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Grammary $proxy) {
