...
class __TwigTemplate_08f08f2eef7b003a2bf5814704cb002591fda0b8b853fa364f3e54acd901ab13 extends Twig_Template
{
    ...
    <div class=\"btn-group\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["part"]) {
            ...
            echo "\" href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("sentences", array("sentences_package_id" => $this->getAttribute((isset($context["part"]) ? $context["part"] : null), "id"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["part"]) ? $context["part"] : null), "name"), "html", null, true);
            echo "</a></li>
                 ";
    ...
    ";
        // line 22
        if ((isset($context["sentences"]) ? $context["sentences"] : null)) {
            // line 23
            echo "    <div class=\"margin-top-50\">
            ";
            // line 24
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["sentences"]) ? $context["sentences"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["sentence"]) {
                // line 25
                echo "        <div class=\"margin-top-50\">
            <h5><strong>";
                // line 26
                echo nl2br(twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["sentence"]) ? $context["sentence"] : null), "subpart"), "name"), "html", null, true));
                echo "</strong> (";
                echo nl2br(twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["sentence"]) ? $context["sentence"] : null), "part"), "name"), "html", null, true));
                echo ")</h5>
            <h2>";
                // line 27
                echo nl2br(twig_escape_filter($this->env, $this->getAttribute((isset($context["sentence"]) ? $context["sentence"] : null), "title"), "html", null, true));
                echo "</h2>
        ...
        <div>
            <p>";
                // line 31
                echo nl2br(twig_escape_filter($this->env, $this->getAttribute((isset($context["sentence"]) ? $context["sentence"] : null), "content"), "html", null, true));
                echo "</p>
        </div>
            ";
            }
