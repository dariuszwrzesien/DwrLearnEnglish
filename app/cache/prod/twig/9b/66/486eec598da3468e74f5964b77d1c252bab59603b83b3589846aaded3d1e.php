...
class __TwigTemplate_9b66486eec598da3468e74f5964b77d1c252bab59603b83b3589846aaded3d1e extends Twig_Template
{
    ...
    <div class=\"btn-group\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["part"]) {
            // line 13
            echo "                <li><a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("words_list", array("words_package" => $this->getAttribute((isset($context["part"]) ? $context["part"] : null), "part"))), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["part"]) ? $context["part"] : null), "part"), "html", null, true);
            echo "</a></li>
                 ";
        }
    ...
    ";
        // line 18
        if ((isset($context["words_package"]) ? $context["words_package"] : null)) {
            // line 19
            echo "    <div>
